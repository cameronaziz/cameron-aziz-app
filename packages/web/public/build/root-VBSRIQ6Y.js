...
var Navigation = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "navbar-nav navbar-nav-hovers d-inline"
  }, /* @__PURE__ */ React.createElement("li", {
    className: "nav-item my-auto ms-3 ms-lg-0"
  }), /* @__PURE__ */ React.createElement("li", {
    className: `nav-item my-auto ms-3 ms-lg-0 ${isOpen ? "collapse-show" : "collapse"} navbar-collapse`
  }, /* @__PURE__ */ React.createElement(button_default, {
    label: "Blog",
    color: "secondary"
  }))), /* @__PURE__ */ React.createElement("button", {
    onClick: toggleNavigation,
    className: `navbar-toggler d-relative t-0 shadow-none ms-auto ${isOpen ? "collapsed" : ""}`,
    type: "button",
...
//# sourceMappingURL=/build/root-VBSRIQ6Y.js.map
