...
var List = (props) => {
  const { defaultExpanded: defaultExpanded2, children } = props;
  ...
  return /* @__PURE__ */ React.createElement("div", {
    className: `${isOpen ? "collapse-show" : "collapse"} collapse navbar-collapse py-lg-0 collapsible-nav`
...
// app/components/navigation/index.tsx
var Navigation = () => {
  const [isOpen2, setIsOpen] = (0, import_react3.useState)(false);
  const clickGithub = () => {
...
//# sourceMappingURL=/build/root-MG3PM2JO.js.map
