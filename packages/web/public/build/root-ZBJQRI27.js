...
var List = (props) => {
  const { defaultExpanded: defaultExpanded2, children, target } = props;
  const defaultExpandedRef = (0, import_react.useRef)(defaultExpanded2);
  ...
  const classTarget = target.startsWith(".") ? `${target} ` : "";
  const idTarget = target.startsWith("#") ? target : "";
  return /* @__PURE__ */ React.createElement("div", {
    className: `${classTarget}${defaultExpandedRef.current ? "collapse-show" : "collapse"} navbar-collapse py-lg-0 collapsible-nav`
...
var Toggle = (props) => {
  const { onClick, target, defaultExpanded: defaultExpanded2 } = props;
  const defaultExpandedRef = (0, import_react2.useRef)(defaultExpanded2);
...
//# sourceMappingURL=/build/root-ZBJQRI27.js.map
