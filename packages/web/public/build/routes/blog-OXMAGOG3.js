...
var Blog = () => {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "row"
  }, /* @__PURE__ */ React.createElement(blogSummary_default, {
    ...
    imageSource: "https://images.unsplash.com/photo-1518791841217-8f162f1e1131?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80"
  }), /* @__PURE__ */ React.createElement("div", {
    className: "col-lg-3 col-sm-6"
  }, /* @__PURE__ */ React.createElement("div", {
    className: "card card-plain card-blog"
    ...
    className: "w-100 border-radius-lg move-on-hover shadow",
    src: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/color-bags.jpg"
  }))), /* @__PURE__ */ React.createElement("div", {
    className: "card-body px-0"
  }, /* @__PURE__ */ React.createElement("h5", null, /* @__PURE__ */ React.createElement("a", {
    href: "javascript:;",
    className: "text-dark font-weight-bold"
  }, "Rover raised $65 million")), /* @__PURE__ */ React.createElement("p", null, "Finding temporary housing for your dog should be as easy as renting an Airbnb. That\u2019s the idea behind Rover ..."), /* @__PURE__ */ React.createElement("a", {
    href: "javascript:;",
    className: "text-info icon-move-right"
  }, "Read More", /* @__PURE__ */ React.createElement("i", {
    className: "fas fa-arrow-right text-sm"
...
//# sourceMappingURL=/build/routes/blog-OXMAGOG3.js.map
