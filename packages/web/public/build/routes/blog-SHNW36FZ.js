...
var createStore = (initialValues) => {
  ...
  const setAtomValue = (version, atom2, value2, dependencies, suspensePromise) => {
  ...
  const setAtomPromiseOrValue = (version, atom2, promiseOrValue, dependencies) => {
    if (promiseOrValue instanceof Promise) {
      const suspensePromise = createSuspensePromise(promiseOrValue.then((value2) => {
        setAtomValue(version, atom2, value2, dependencies, suspensePromise);
        flushPending(version);
      }).catch((e) => {
  ...
  const restoreAtoms = (values, version) => {
    for (const [atom2, value2] of values) {
      if (hasInitialValue(atom2)) {
        setAtomPromiseOrValue(version, atom2, value2);
...
function useAtom(atom2, scope) {
  ...
  const [[version, value2, atomFromUseReducer], rerenderIfChanged] = (0, import_react.useReducer)((0, import_react.useCallback)((prev, nextVersion) => {
  ...
  (0, import_react.useDebugValue)(value2);
  return [value2, setAtom];
}
...
var Blog = () => {
  ...
  (0, import_react2.useEffect)(() => {
    setBookCleaning((previousBooking) => {
      return {
        ...previousBooking,
        [key]: value
      };
...
//# sourceMappingURL=/build/routes/blog-SHNW36FZ.js.map
