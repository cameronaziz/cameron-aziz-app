...
var getClassName = (props) => {
  ...
  const className = props.className ? `${props.className} ` : "me-1";
  return `btn ${backgroundColor}${padding}${size}${round}${icon}${className}`;
};
...
//# sourceMappingURL=/build/_shared/chunk-25XDU2Q6.js.map
