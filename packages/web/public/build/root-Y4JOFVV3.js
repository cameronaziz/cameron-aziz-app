...
var Navigation = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "navbar-nav navbar-nav-hovers ms-md-2"
  }, /* @__PURE__ */ React.createElement("li", {
    className: `nav-item my-1 ms-lg-0 my-md-auto ${isOpen ? "collapse-show" : "collapse"} navbar-collapse`
  }, /* @__PURE__ */ React.createElement(button_default, {
    label: "Blog",
    color: "secondary"
  }))), /* @__PURE__ */ React.createElement("div", {
    ...
    className: "ms-md-auto navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100 flex-row"
  }, /* @__PURE__ */ React.createElement("li", {
    className: "nav-item my-1 ms-lg-0 ms-lg-auto my-md-auto"
  }, /* @__PURE__ */ React.createElement(button_default, {
    color: "secondary",
    icon: "github",
    onClick: clickGithub
  })), /* @__PURE__ */ React.createElement("li", {
    className: "nav-item my-1 ms-3 ms-lg-0 ms-lg-auto my-md-auto"
  }, /* @__PURE__ */ React.createElement(button_default, {
    color: "secondary",
    icon: "twitter",
    onClick: clickGithub
...
//# sourceMappingURL=/build/root-Y4JOFVV3.js.map
