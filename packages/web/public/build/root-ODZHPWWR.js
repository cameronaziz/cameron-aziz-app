...
var List = (props) => {
  ...
  const kids = import_react.Children.map(children, (child) => {
    if (child) {
      return /* @__PURE__ */ React.createElement("li", {
        className: `nav-item flex-grow-0 my-1 mx-1 ${isOpen ? "collapse-show" : "collapse"} navbar-collapse`
      }, child);
    }
  });
...
var Navigation = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
  ...
  }))), /* @__PURE__ */ React.createElement(list_default, null, /* @__PURE__ */ React.createElement(button_default, {
    label: "Blog",
    color: "secondary"
  }), /* @__PURE__ */ React.createElement(button_default, {
    label: "Experience",
    ...
    className: "ms-auto me-auto me-md-0 navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-auto flex-row"
  }, /* @__PURE__ */ React.createElement("li", {
...
//# sourceMappingURL=/build/root-ODZHPWWR.js.map
