...
var List = (props) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    id: idTarget,
    className: `${className ? `${className}` : ""}${classTarget}${defaultExpandedRef.current ? "collapse-show" : "collapse"} navbar-collapse collapsible-nav`,
    ...rest
  }, /* @__PURE__ */ React.createElement("ul", {
    className: "ms-auto me-auto me-md-0 navbar-nav navbar-nav-hovers ms-md-2 flex-row me-md-auto"
  }, kids));
};
...
//# sourceMappingURL=/build/root-UVRFBKRV.js.map
