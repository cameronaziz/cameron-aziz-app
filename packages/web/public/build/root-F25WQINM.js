...
var Navigation = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: `nav-item my-1 ms-3 ms-lg-0 my-md-auto ${isOpen ? "collapse-show" : "collapse"} navbar-collapse`
  }, /* @__PURE__ */ React.createElement(button_default, {
    label: "Blog",
    color: "secondary"
  }))), /* @__PURE__ */ React.createElement("div", {
    ...
    className: "nav-item my-1 ms-3 ms-lg-0 ms-lg-auto my-md-auto d-md-list-item"
  }, /* @__PURE__ */ React.createElement(button_default, {
    color: "secondary",
    icon: "github",
    onClick: clickGithub
  })), /* @__PURE__ */ React.createElement("li", {
    className: "nav-item my-1 ms-3 ms-lg-0 ms-lg-auto my-md-auto d-md-inline"
  }, /* @__PURE__ */ React.createElement(button_default, {
    color: "secondary",
    icon: "twitter",
    onClick: clickGithub
...
//# sourceMappingURL=/build/root-F25WQINM.js.map
