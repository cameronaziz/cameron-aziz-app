...
var Navigation = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: `nav-item my-1 ms-md-3 ms-lg-0 my-md-auto ${isOpen ? "collapse-show" : "collapse"} navbar-collapse`
  }, /* @__PURE__ */ React.createElement(button_default, {
    label: "Blog",
    color: "secondary"
  }))), /* @__PURE__ */ React.createElement("div", {
    ...
    className: "navbar-nav navbar-expand-md navbar-nav-hover ms-lg-12 ps-lg-5 w-100"
  }, /* @__PURE__ */ React.createElement("li", {
    className: "nav-item my-1 ms-md-3 ms-lg-0 ms-lg-auto my-md-auto d-block d-md-list-item"
  }, /* @__PURE__ */ React.createElement(button_default, {
    color: "secondary",
    icon: "github",
    onClick: clickGithub
...
//# sourceMappingURL=/build/root-PKJP67W6.js.map
