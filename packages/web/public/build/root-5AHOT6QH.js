...
var List = (props) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    id: idTarget,
    className: `${className ? `${className}` : ""}${classTarget}${defaultExpandedRef.current ? "collapse-show" : "collapse"} navbar-collapse py-lg-0 collapsible-nav`,
    ...rest
...
var Navigation = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "flex justify-content-between flex-grow-1"
...
//# sourceMappingURL=/build/root-5AHOT6QH.js.map
